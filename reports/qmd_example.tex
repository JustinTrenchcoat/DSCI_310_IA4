...
\caption{\label{fig-pop}Horse populations for all provinces in Canada
from 1906 - 1972.}

\end{figure}%

We can see from Figure~\ref{fig-pop} that Ontario, Saskatchewan and
...
populations. We present the standard deviations in Table~\ref{tbl-sd}.

\begin{longtable}[]{@{}lr@{}}

\caption{\label{tbl-sd}Standard deviation of historical (1906-1972)
horse populations for each Canadian province.}
...
Additionally, note that in Table~\ref{tbl-sd} we consider the sample
...
\caption{\label{fig-sd}Horse populations for the province with the
largest standard deviation}

\end{figure}%

In Figure~\ref{fig-sd} we zoom in and look at the province of
